...
We create a new workflow to test on vSphere. The [individual steps](https://github.com/openshift/release/tree/master/ci-operator/step-registry/ipi/conf/vsphere/proxy/https)
